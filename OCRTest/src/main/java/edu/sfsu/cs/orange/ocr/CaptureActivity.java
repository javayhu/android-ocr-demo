...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
     ...
     */
    public static final String DEFAULT_TRANSLATOR = "Bing Translator";//Google Translate
     ...
     */
    static final String OSD_FILENAME = "tesseract-ocr-3.01.osd.tar";//如果去下载的话文件名是OSD_FILENAME

    /**
     * Destination filename for orientation and script detection (OSD) data.
     */
    static final String OSD_FILENAME_BASE = "osd.traineddata";//如果是保存在手机中的文件名是OSD_FILENAME_BASE
